...
const replacements = [
    ...
    // Adjust RGBA backgrounds globally for a slightly darker/glassy feel in some layers (31, 31, 31, 0.7 -> 32, 32, 32, 0.8)
    [/rgba\(31,\s*31,\s*31,\s*0\.7\)/g, 'rgba(32, 32, 32, 0.8)'],
    // Make 1px borders slightly brighter for premium feel
