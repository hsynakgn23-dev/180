...
const PLAN_FALLBACKS: Plan[] = [
  ...
  },
  {
    ...
    badge: 'YILLIK',
    accent: CLAY,
    summary: 'Tam yıl deneyim',
    detail: 'Yıl boyunca premium.',
    meta: 'Reklamsız + limitsiz',
  },
  {
    key: 'supporter',
...
const PAYWALL_LEGAL_COPY: Record<PaywallLanguage, {
  ...
  tr: {
    ...
    planSummaries: { monthly: 'Esnek başlangıç', annual: 'Tam yıl deneyim', supporter: 'Destek paketi' },
    planDetails: { monthly: 'İstediğin zaman çık.', annual: 'Yıl boyunca premium.', supporter: 'Projeyi doğrudan destekle.' },
    planMetas: { monthly: 'Reklamsız + limitsiz', annual: 'Reklamsız + limitsiz', supporter: 'Kalıcı destek paketi' },
    planPeriods: { monthly: 'aylık yenilenir', annual: 'yıllık yenilenir', supporter: 'tek seferlik' },
    planBadgeAnnual: 'YILLIK',
  ...
  en: {
    ...
    planSummaries: { monthly: 'Flexible start', annual: 'Full-year access', supporter: 'Support pack' },
    planDetails: { monthly: 'Cancel anytime.', annual: 'Premium for the full year.', supporter: 'Support the project directly.' },
    planMetas: { monthly: 'Ad-free + unlimited', annual: 'Ad-free + unlimited', supporter: 'Permanent support pack' },
    planPeriods: { monthly: 'renews monthly', annual: 'renews annually', supporter: 'one-time' },
    planBadgeAnnual: 'ANNUAL',
  ...
  es: {
    ...
    planSummaries: { monthly: 'Inicio flexible', annual: 'Acceso anual', supporter: 'Paquete de apoyo' },
    ...
    planMetas: { monthly: 'Sin anuncios + ilimitado', annual: 'Sin anuncios + ilimitado', supporter: 'Paquete de apoyo permanente' },
    planPeriods: { monthly: 'se renueva mensualmente', annual: 'se renueva anualmente', supporter: 'pago único' },
    planBadgeAnnual: 'ANUAL',
  ...
  fr: {
    ...
    planSummaries: { monthly: 'Démarrage flexible', annual: 'Accès annuel', supporter: 'Pack de soutien' },
    ...
    planMetas: { monthly: 'Sans pub + illimité', annual: 'Sans pub + illimité', supporter: 'Pack de soutien permanent' },
    planPeriods: { monthly: 'renouvellement mensuel', annual: 'renouvellement annuel', supporter: 'paiement unique' },
    planBadgeAnnual: 'ANNUEL',
